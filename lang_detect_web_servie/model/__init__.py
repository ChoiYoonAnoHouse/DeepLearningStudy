...
def preprocessing( oriText=None ):
    if not oriText:
        ...
        print( len(a_txt) / oriTextSize )
        print( len(h_txt) / oriTextSize )
        print( len(j_txt) / oriTextSize )

        # 5. 개별문자수/전체원본문자수 비중에 50%이상일경우 해당문자로 분류
...
if __name__ == '__main__':
    ...
    print(  predictMainStream('sdfnsdkjfnsdlkvnweolcnwelkvnerlkvnselkcnselk') )
    pass